...
const portfolioItems: IPortfolioItem[] = [
  ...
  },
  {
    ...
    description: {
      en: ["A React component to build friendly mobile dialog interactions"],
      es: [
  ...
  },
  {
    ...
    description: {
      ...
      es: ["Una mezcla entre Pong y Arkanoid. Hecho con Phaser y Typescript."],
    },
  },
  {
    name: "Flappy Dragon",
    ...
    publicUrl: "https://fpellicero.github.io/flappy_dragon",
    description: {
      en: [
      ...
      es: ["Un clon del popular Flappy Bird. Hecho con Phaser y Javascript."],
    },
  },
  {
    name: "Untitled Game",
